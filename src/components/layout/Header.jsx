      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
        <Link to="/" className="flex min-w-0 items-center gap-2.5 sm:gap-3" aria-label="TK SHOP — Taye et Kinde Shop, accueil">
          ...
          <span className="leading-none">
            <span className="block whitespace-nowrap font-display text-lg tracking-[.1em] sm:text-2xl sm:tracking-[.12em]">TK SHOP</span>
            <span className="mt-1.5 block whitespace-nowrap text-[6px] font-semibold uppercase tracking-[.14em] text-ink/65 sm:text-[8px] sm:tracking-[.22em] lg:text-[9px]">Taye &amp; Kinde Shop</span>
          </span>
        </Link>

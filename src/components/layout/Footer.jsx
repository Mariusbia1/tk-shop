...
export default function Footer() {
  return <footer className="bg-gradient-to-br from-[#413416] via-plum to-ink text-white"><div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-4 lg:px-8">
    <div className="md:col-span-2"><p className="mb-3 text-[10px] font-bold uppercase tracking-[.25em] text-sand">Crocheté avec passion à Cotonou</p><h2 className="font-display text-3xl">{siteConfig.name}</h2><p className="mt-4 max-w-md text-sm leading-7 text-white/60">{siteConfig.description}</p></div>

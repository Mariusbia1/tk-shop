...
import heroCrochet from '../../assets/crochet-dress-pink.jpg'
...
export default function HomePage() {
  return <><SEO title="Marlène Shop | Créations crochetées à la main" />
      ...
      <div className="relative mx-auto grid min-h-[82vh] max-w-7xl items-center gap-10 px-5 py-12 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, scale: .96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: .7 }} className="relative mx-auto w-full max-w-xl">
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-[3rem_3rem_8rem_3rem] shadow-rose">
            <img src={heroCrochet} alt="Robe en crochet rose Marlène Shop" className="h-full w-full object-cover" />
    ...
    <section className="knit-texture mx-auto max-w-4xl px-5 py-24 text-center"><p className="text-xs font-bold uppercase tracking-[.2em] text-gold">L’art du crochet</p><h2 className="mt-5 font-display text-4xl leading-tight md:text-5xl">Un point après l’autre.<br /><span className="italic text-gold">Une émotion à porter.</span></h2><p className="mx-auto mt-6 max-w-2xl leading-8 text-black/60">Chez Marlène Shop, le fil de coton devient une silhouette moderne entre les mains de la créatrice. Chaque boucle est crochetée avec patience pour créer une pièce douce, durable et vraiment personnelle.</p></section>
    ...
    <section className="grid overflow-hidden bg-linen md:mx-5 md:rounded-[3rem] md:grid-cols-2"><div className="relative min-h-[500px]"><img src={heroCrochet} alt="Création au crochet dans l’atelier" className="absolute inset-0 h-full w-full object-cover" /><div className="absolute inset-0 bg-rose/20 mix-blend-color" /><div className="absolute inset-0 bg-gradient-to-t from-plum/25 to-transparent" /></div><div className="knit-texture flex items-center p-10 md:p-20"><div><p className="text-xs font-bold uppercase tracking-[.2em] text-gold">La main derrière le crochet</p><h2 className="mt-5 font-display text-4xl md:text-5xl">Le crochet comme langage</h2><p className="mt-6 max-w-lg leading-8 text-black/65">Marlène imagine des silhouettes féminines à partir de fils doux, de boucles et de motifs ajourés. Chaque pièce porte la trace du geste, le temps de la création et une attention rien que pour vous.</p><Button to="/a-propos" variant="outline" className="mt-8">Entrer dans l’atelier</Button></div></div></section>
